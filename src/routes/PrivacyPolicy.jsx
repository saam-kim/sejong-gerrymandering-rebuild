    ...
    <main className="min-h-screen bg-white px-5 py-12 text-gray-900">
      <div className="mx-auto max-w-2xl">
        ...
        <Section title="제4조 (처리 및 보유 기간)">
          <p>
            서비스는 현재 자동 삭제 기능을 제공하지 않으며, 교사가 대시보드의 모둠 삭제
            기능을 사용하거나 Firebase 콘솔에서 직접 삭제하는 수동 절차로 처리합니다.{" "}
            <b>모둠 데이터는 늦어도 해당 데이터가 생성된 학기가 종료되는 시점까지 삭제를
            완료합니다</b> — 이는 서비스 운영자가 학기 단위로 실제 지키는 삭제 주기입니다.
            수업 종료 후에는 더 빠른 삭제를 권장하며, 향후 자동 파기 기능 도입을 검토하고
            있습니다.
          </p>
        </Section>
